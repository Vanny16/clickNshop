          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-success text-gradient">Welcome Shopper!</h3>
                  <p class="mb-0">Please enter your credentials to proceed<br></p>
                </div>
                <div class="card-body">
                ...
                <small class="text-muted">Forgot you password? Reset you password
                  <a href="/login/forgot-password" class="text-success text-gradient font-weight-bold">here</a>
                </small>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/homebg1.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
